...
setup(
    ...
    long_description = "The client-side Python API Kinetica.  Create, store, retrieve, and query data with ease and speed.",
    author = 'Kinetica DB Inc.',
    author_email = 'mmahmud@kinetica.com',
    package_data = {'gpudb': extra_files},
    url = 'http://www.kinetica.com',
    download_url = 'https://github.com/kineticadb/kinetica-api-python/archive/v6.2.0.1.tar.gz',
